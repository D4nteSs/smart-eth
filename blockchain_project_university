//Смарт, который получает две даты и отслеживает удовлетворение условий сделки пользователя. 
//В случае неудовлетвоерения забирает всю крипту поставленную на его цель, в случае выполенения всех задач - поощеряет
